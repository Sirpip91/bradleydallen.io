      ...
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
        <div className="min-w-48 max-w-48 flex flex-col gap-2">
          <Avatar className="h-48 w-48">
            <AvatarImage src="https://yt3.ggpht.com/GKvoDZysnAYSZBz4amIOhatls1uczmsYx8-FfmGeMN9fhQSo-oFPh_nGMZwzXHLNO3mJ5OcKVwI=s108-c-k-c0x00ffffff-no-rj" alt={siteConfig.author} />
