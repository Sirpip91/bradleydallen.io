...
export function MainNav(){
    ...
    return <nav className="flex items-center space-x-4 lg:space-x-6">
        ...
        <Link href="/blog" className={cn("text-lg font-medium transition-colors hover:text-primary hidden sm:inline-block",pathname ==="/blog" ? "text-foreground" : "text-foreground/60")}
        >
            Blog
        </Link>
